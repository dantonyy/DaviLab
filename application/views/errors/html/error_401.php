...
<html>
    ...
    <body>
        <div class="centralizacaoTotal">
            <h1 class="centralizacaoTexto animacaoZoom"><?php echo lang('numero_erro_401');?></h1>
            <h1 class="fonteDestaque animacaoTopo centralizacaoTexto"><code><?php echo lang('acesso_negado_401');?></code></h1><br>
            <hr class="divisorBranco animacaoEsquerda" style="margin:auto;width:50%"><br>
            <h3 class="centralizacaoTexto animacaoDireita"><?php echo lang('mensagem_erro_401');?></h3><br><br>
            <h4 class="centralizacaoTexto animacaoZoom" ><?php echo lang('texto_erro_401');?><a style="color: white" href="<?php echo base_url("login");?>"><?php echo lang('link_login_401')?></a></h4>
        </div>
    </body>
</html>