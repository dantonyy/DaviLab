            ...
            <div class="tab-content pt-2">
                ...
                <form>
                    ...
                    <div class="col-md-8 col-lg-9">
                        <img src="
                            <?php echo base_url();?>application/views/dashboard/assets/img/foto_perfil.jpg" 
                            alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo $this->session->userdata('nome').' '. $this->session->userdata('sobrenome');?>" disabled>
                    </div>
                    </div>
                    ...
                    <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo $this->session->userdata('nome_fantasia');?>" disabled>
                    </div>
                    </div>
